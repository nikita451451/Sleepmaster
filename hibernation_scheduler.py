...
APP_NAME = "TimeMaster"
APP_VERSION = "3.0"
CONFIG_FILE = os.path.expanduser("~/.timemaster_config.json")
APP_ICON = "sleep_icon.ico"
...
class TimeMasterApp(ctk.CTk):
    ...
    def setup_icon(self):
        ...
        try:
            if sys.platform == "win32":
                ...
                self.iconphoto(False, ctk.CTkImage(img))
        except:
            pass
    ...
    def add_program(self):
        ...
        file_types = [("Исполняемые файлы", "*.exe"), ("Все файлы", "*.*")]
    ...
    def create_advanced_settings(self, tab):
        ...
        bios_info = ctk.CTkLabel(
            ...
            text="Для работы функции автоматического включения компьютера:\n"
                 ...
                 "3. Активируйте опцию 'Wake on RTC' или 'Resume by Alarm'\n"
    ...
    def execute_action(self, action):
        ...
        if sys.platform == "win32":
            cmd = action_map.get(action, "shutdown /s /f /t 0")
            try:
